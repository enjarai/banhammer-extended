...
public class Helpers {
    public static String getFormattedDuration(long time, boolean relative) {
        if (time > -1) {
            long x = relative ? System.currentTimeMillis() / 1000 - time : time;
    ...
    public static PunishmentTypes punishmentTypeFromString(String string) {
        return switch (string) {
            case "ban" -> PunishmentTypes.BAN;
