package nl.enjarai.banhammer.config;
...
import nl.enjarai.banhammer.config.data.ConfigData;
import nl.enjarai.banhammer.config.data.DiscordMessageData;
import nl.enjarai.banhammer.config.data.MessageConfigData;
...
public class Config {
    ...
    public final Text punishmentHistoryHeader;
    public final Text punishmentHistoryEntry;
    public final Text punishmentHistoryNoneEntry;
    ...
    public Config(ConfigData data, MessageConfigData mData, DiscordMessageData discordMessages) {
        ...
        this.punishmentHistoryHeader = toSingleString(mData.punishmentHistoryHeader);
        this.punishmentHistoryEntry = toSingleString(mData.punishmentHistoryEntry);
        this.punishmentHistoryNoneEntry = toSingleString(mData.punishmentHistoryNoneEntry);
